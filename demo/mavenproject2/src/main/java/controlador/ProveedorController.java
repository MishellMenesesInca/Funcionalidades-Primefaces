...
import modelo.dao.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private modelo.dao.ProveedorFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("vistas").getString("ProveedorCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("vistas").getString("ProveedorUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("vistas").getString("ProveedorDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Proveedor getProveedor(java.math.BigDecimal id) {
